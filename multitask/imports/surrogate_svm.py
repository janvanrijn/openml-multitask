# copied from HPOLib surrogate branch
import os
import pickle
import numpy as np
...
class SurrogateSVM(AbstractBenchmark):
    ...
    def objective_function(self, x, dataset_fraction=1, **kwargs):
        ...
        result = {'function_value': y, "cost": c}
        print('calling objective function with', test_point, result)
        return result
    ...
    def objective_function_test(self, x, **kwargs):
        ...
        c = self.surrogate_cost.predict(test_point)[0]
        result = {'function_value': y, "cost": c}
        print('calling objective function [TEST] with', test_point, result)
        return result
